...
public class JwtUtil {
    ...
    public String generateToken(MeritBankUser userDetails) {
        return Jwts.builder().claim("role", userDetails.getRole()).claim("id", userDetails.getId()).setSubject(userDetails.getUsername()).setIssuedAt(new Date(System.currentTimeMillis()))
